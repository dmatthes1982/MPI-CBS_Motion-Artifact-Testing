...
if ~exist('sessionStr', 'var')
  ...
  cfg.filename  = 'MAT_d01_01c_repaired';
...
if ~exist('numOfPart', 'var')                                               % estimate number of participants in segmented data folder
  ...
  for i=1:1:numOfSources
    numOfPart(i)  = sscanf(sourceList{i}, ...
                    strcat('MAT_d%d_01c_repaired_', sessionStr, '.mat'));
  end
end
...
for i = numOfPart
  ...
  ft_info off;
  data_preproc = MAT_preprocessing( cfg, data_repaired);
  ft_info on;
  ...
  fprintf('%s ...\n', file_path);
  MAT_saveData(cfg, 'data_preproc', data_preproc);
  fprintf('Data stored!\n\n');
