...
if ~exist('sessionStr', 'var')
  cfg           = [];
  cfg.subfolder = '03d_pwelch_preproc';
  cfg.filename  = 'MAT_d01_03d_pwelch_preproc';
...
if ~exist('numOfPart', 'var')                                               % estimate number of participants in pwelch_preproc folder
  sourceList    = dir([strcat(desPath, '03d_pwelch_preproc/'), ...
  ...
  for i=1:1:numOfSources
    numOfPart(i)  = sscanf(sourceList{i}, ...
                    strcat('MAT_d%d_03d_pwelch_preproc_', sessionStr, '.mat'));
  end
end
...
cprintf([0,0.6,0], '<strong>[4] - Averaging TFR and pWelch results</strong>\n');
fprintf('\n');
...
for i = numOfPart
  ...
  cfg.srcFolder   = strcat(desPath, '03a_tfr_raw/');
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04a_tfroc_raw/');
  cfg.filename    = sprintf('MAT_d%02d_04a_tfroc_raw', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '03b_tfr_preproc/');
  cfg.sessionStr  = sessionStr;
  ...
  % export TFR data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04b_tfroc_preproc/');
  cfg.filename    = sprintf('MAT_d%02d_04b_tfroc_preproc', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '03c_pwelch_raw/');
  cfg.sessionStr  = sessionStr;
  ...
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04c_pwelchoc_raw/');
  cfg.filename    = sprintf('MAT_d%02d_04c_pwelchoc_raw', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '03d_pwelch_preproc/');
  cfg.sessionStr  = sessionStr;
  ...
  % export PSD data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04d_pwelchoc_preproc/');
  cfg.filename    = sprintf('MAT_d%02d_04d_pwelchoc_preproc', i);
  cfg.sessionStr  = sessionStr;
...
for i = numOfPart
  ...
  cfg.srcFolder   = strcat(desPath, '04a_tfroc_raw/');
  cfg.sessionStr  = sessionStr;
  cfg.filename    = sprintf('MAT_d%02d_04a_tfroc_raw', i);
  ...
  % export TFR data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04e_tfrop_raw/');
  cfg.filename    = sprintf('MAT_d%02d_04e_tfrop_raw', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '04b_tfroc_preproc/');
  cfg.sessionStr  = sessionStr;
  cfg.filename    = sprintf('MAT_d%02d_04b_tfroc_preproc', i);
  ...
  % export TFR data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04f_tfrop_preproc/');
  cfg.filename    = sprintf('MAT_d%02d_04f_tfrop_preproc', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '04c_pwelchoc_raw/');
  cfg.sessionStr  = sessionStr;
  cfg.filename    = sprintf('MAT_d%02d_04c_pwelchoc_raw', i);
  ...
  % export PSD data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04g_pwelchop_raw/');
  cfg.filename    = sprintf('MAT_d%02d_04g_pwelchop_raw', i);
  cfg.sessionStr  = sessionStr;
  ...
  cfg.srcFolder   = strcat(desPath, '04d_pwelchoc_preproc/');
  cfg.sessionStr  = sessionStr;
  cfg.filename    = sprintf('MAT_d%02d_04d_pwelchoc_preproc', i);
  ...
  % export PSD data into a *.mat file
  cfg             = [];
  cfg.desFolder   = strcat(desPath, '04h_pwelchop_preproc/');
  cfg.filename    = sprintf('MAT_d%02d_04h_pwelchop_preproc', i);
  cfg.sessionStr  = sessionStr;
