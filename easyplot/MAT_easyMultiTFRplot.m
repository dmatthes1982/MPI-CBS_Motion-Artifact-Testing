function MAT_easyMultiTFRplot(cfg, data)
% MAT_EASYTFRPLOT is a function, which makes it easier to create a multi
...
%
% See also FT_MULTIPLOTTFR, MAT_TIMEFREQANALYSIS
