function MAT_easyPlot( cfg, data )
% MAT_EASYPLOT is a function, which makes it easier to plot the data of a 
% specific condition and trial from the MAT_DATASTRUCTURE.
%
% Use as
%   MAT_easyPlot(cfg, data)
%
% where the input data can be the results of MAT_IMPORTDATASET or
% MAT_PREPROCESSING
%
% The configuration options are
%   cfg.part      = number of participant (default: 1)
%   cfg.condition = condition (default: 100 or 'No movement', see MAT data structure)
%   cfg.electrode = number of electrode (default: 'Cz')
%   cfg.trial     = number of trial (default: 1)
%
% This function requires the fieldtrip toolbox.
%
% See also MAT_DATASTRUCTURE, PLOT
