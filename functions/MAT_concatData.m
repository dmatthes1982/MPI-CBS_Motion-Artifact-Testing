function [ data ] = MAT_concatData( data )
% MAT_CONCATDATA concatenate all trials of a dataset to a continuous data
% stream.
%
% Use as
%   [ data ] = MAT_concatData( data )
%
% where the input can be i.e. the result from MAT_IMPORTDATASET or 
% MAT_PREPROCESSING
%
% This function requires the fieldtrip toolbox.
%
% See also MAT_IMPORTDATASET, MAT_PREPROCESSING
