function [ cfgArtifacts ] = MAT_databrowser( cfg, data )
% MAT_DATABROWSER displays a certain joint attention imitation project 
% dataset using a appropriate scaling.
%
% Use as
%   MAT_databrowser( cfg, data )
%
% where the input can be the result of MAT_IMPORTDATASET,
...
% MAT_DATASTRUCTURE, FT_DATABROWSER
...
if isempty(dyad)                                                            % if dyad number is not specified
  ...
  source = '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_rawData/';
  filename = sprintf('DualEEG_MAT_%02d.vhdr', dyad);
