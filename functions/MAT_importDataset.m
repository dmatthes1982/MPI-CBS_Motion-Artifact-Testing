function [ data ] = MAT_importDataset(cfg)
% MAT_IMPORTDATASET imports one specific dataset recorded with a device 
% from brain vision.
%
% Use as
%   [ data ] = MAT_importDataset(cfg)
%
% The configuration options are
%   cfg.path        = source path' (i.e. '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_rawData/')
...
%
% See also FT_PREPROCESSING, MAT_DATASTRUCTURE
...
headerfile = sprintf('%sDualEEG_MAT_%02d.vhdr', path, dyad);
