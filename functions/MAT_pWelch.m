function [ data ] = MAT_pWelch( cfg, data )
% MAT_PWELCH calculates the power spectral density using Welch's method for
% every condition of every participant in the dataset.
%
% Use as
%   [ data ] = MAT_pWelch( cfg, data)
%
% where the input data hast to be the result from MAT_SEGMENTATION
%
