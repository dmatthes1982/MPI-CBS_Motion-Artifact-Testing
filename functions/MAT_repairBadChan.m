function [ data_repaired ] = MAT_repairBadChan( data_badchan, data_raw )
% MAT_REPAIRBADCHAN can be used for repairing previously selected bad
...
%
% SEE also MAT_DATABROWSER and FT_CHANNELREPAIR
...
MAT_databrowser( cfgView, data_repaired );
