function [ data_badchan ] = MAT_selectBadChan( data_raw )
% MAT_SELECTBADCHAN can be used for selecting bad channels visually. The
% data will be presented in the fieldtrip databrowser view and the bad
% channels will be marked in the MAT_CHANNELCHECKBOX gui. The function
...
%
% Use as
%   [ data_badchan ] = MAT_selectBadChan( data_raw )
%
% where the input has to be raw data
%
% The function requires the fieldtrip toolbox
%
% SEE also MAT_DATABROWSER and MAT_CHANNELCHECKBOX
...
MAT_databrowser( cfg, data_raw );
badLabel = MAT_channelCheckbox();
