function MAT_loadData( cfg )
% MAT_LOADDATA loads a specific MAT dataset
%
% Use as
%   MAT_loadData( cfg )
%
% The configuration options are
%   cfg.srcFolder   = source folder (default: '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_processedData/01_raw/')
...
% Get config options
% -------------------------------------------------------------------------
srcFolder   = ft_getopt(cfg, 'srcFolder', '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_processedData/01_raw/');
