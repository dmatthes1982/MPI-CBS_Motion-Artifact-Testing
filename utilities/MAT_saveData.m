function MAT_saveData( cfg, varargin )
% MAT_SAVEDATA stores the data of various structure elements (generally the
% MAT-datastructures) into a MAT_File.
%
% Use as
%   MAT_saveData( cfg, varargin )
%
% The configuration options are
%   cfg.desFolder   = destination folder (default: '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_processedData/01_raw/')
...
% Get config options
% -------------------------------------------------------------------------
desFolder   = ft_getopt(cfg, 'desFolder', '/data/pt_01826/eegData_MotionArtifactTesting/DualEEG_MAT_processedData/01_raw/');
